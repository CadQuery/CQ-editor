...
a = Analysis(['run.py'],
             ...
             hiddenimports=['ipykernel.datapub', 'vtkmodules', 'vtkmodules.all',
                            ...
                            'pyqtgraph.imageview.ImageViewTemplate_pyqt5', 'debugpy', 'xmlrpc', 'importlib_resources.trees'] + hiddenimports1 + hiddenimports2,
             hookspath=[],
             runtime_hooks=['pyinstaller/pyi_rth_occ.py',
                            'pyinstaller/pyi_rth_fontconfig.py'],
             excludes=['_tkinter','/Users/runner/miniconda3/envs/test/lib/python3.8/site-packages/importlib_resources/version.txt','/Users/runner/miniconda3/envs/test/lib/python3.8/site-packages/importlib_resources/version.txt'],
