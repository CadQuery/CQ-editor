...
if sys.platform == 'win32':
    ssl_dll_path = (os.path.join(HOMEPATH, 'Library', 'bin', 'libssl-1_1-x64.dll'), '.')
    ssl_pdb_path = (os.path.join(HOMEPATH, 'Library', 'bin', 'libssl-1_1-x64.pdb'), '.')
    crypto_dll_path = (os.path.join(HOMEPATH, 'Library', 'bin', 'libcrypto-1_1-x64.dll'), '.')
    crypto_pdb_path = (os.path.join(HOMEPATH, 'Library', 'bin', 'libcrypto-1_1-x64.pdb'), '.')
